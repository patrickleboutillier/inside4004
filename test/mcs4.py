...
PROM = [i4001.i4001(0, 1, clk, sync, data, cm_rom), i4001.i4001(1, 1, clk, sync, data, cm_rom), 
    i4001.i4001(2, 0, clk, sync, data, cm_rom), i4001.i4001(3, 1, clk, sync, data, cm_rom)]
for r in PROM:
    MCS4.addROM(r)
